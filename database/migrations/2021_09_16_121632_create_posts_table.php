...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('posts', function (Blueprint $table) {
            ...
            $table->bigInteger('head_equipment_id')->unsigned()->nullable();
            $table->foreign('head_equipment_id')->references('id')->on('equipment');
            $table->bigInteger('chest_equipment_id')->unsigned()->nullable();
            $table->foreign('chest_equipment_id')->references('id')->on('equipment');
            $table->bigInteger('arm_equipment_id')->unsigned()->nullable();
            $table->foreign('arm_equipment_id')->references('id')->on('equipment');
            $table->bigInteger('waist_equipment_id')->unsigned()->nullable();
            $table->foreign('waist_equipment_id')->references('id')->on('equipment');
            $table->bigInteger('leg_equipment_id')->unsigned()->nullable();
            $table->foreign('leg_equipment_id')->references('id')->on('equipment');
            $table->bigInteger('charm_id')->unsigned()->nullable();
